...
- **대시보드**: 오늘/누적 토큰 사용량과 비용, 모듈별 사용량, 최근 7일 차트, Claude CLI 설치·버전·로그인 상태(`claude auth status`, 로그인 안 됐으면 "로그인 필요"), 구독 사용량(마지막 Claude 실행이 보고한 5시간·7일 창 사용률과 초기화 시각), Anthropic 상태 페이지, 작업 진행 현황.
