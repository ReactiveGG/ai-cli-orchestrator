...
마지막 갱신: 2026-09-18 (배포·운영 문서 후) · 가중 완성도 **약 90%**
...
| 12 | 배포·실행 편의 | 3 | 100% | run.cmd/run.sh, 단일 jar(bootJar, 웹 UI 포함, 기동 확인), IntelliJ 공유 실행 구성 3개(.run/) |
| 13 | 문서 | 3 | 90% | README, 운영 가이드(docs/operations.md: 실행·파일 위치·설정 우선순위·문제 해결·백업). 릴리스마다 TODO 갱신만 남음 |
