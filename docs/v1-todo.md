...
마지막 갱신: 2026-09-17 (Claude CLI 실연동 검증 후) · 가중 완성도 **약 72%**
...
| 3 | 병렬 코더 작업 공간 격리 | 12 | 60% | 설계 완료, core 격리 계층·실행 관리자 통합·서버 기본 연결 완료. 스냅샷/수동 적용 API·웹 후보 표·실모델 E2E 남음 |
...
- [ ] server: 스냅샷에 후보 목록·채택·적용 여부, 수동 적용 API `POST /api/jobs/{id}/apply?candidate=k`
- [ ] web: 작업 상세 후보 표(변경 파일/줄 수, 채택 표시, patch 보기, 이 후보 적용)
- [ ] 실모델 E2E: 1-2-2-1 sonnet/low로 후보 2개·1:1 리뷰·채택·적용 확인
